...
export const transformCreateOrdersToRest = (
  ...
  try {
    ...
    const orderObjectBase = {
      ...
      shipmentCount: 1, // Bude přepsáno, pokud je v XML
      sendDate:
    ...
    console.error('Error in transformCreateOrdersToRest:', e);
    return {
      method: 'POST',
      path: '/order/batch',
      body: {},
...
export const transformCreatePickupOrdersToRest = (
  ...
  try {
    ...
    const finalOrder: Order = {
      ...orderObjectBase,
      sender: partialSender as SenderRecipient,
      // recipient pro collectionOrder není
    };
    ...
    console.error('Error in transformCreatePickupOrdersToRest:', e);
    return {
      method: 'POST',
      path: '/order/batch',
      body: {},
...
export const transformGetOrdersToRest = (
  ...
  try {
    ...
    console.error('Error in transformGetOrdersToRest:', e);
    return {
      method: 'GET',
      path: '/order',
      body: null,
...
export const transformCancelOrderToRest = (
  ...
  try {
    ...
    console.error('Error in transformCancelOrderToRest:', e);
    return {
      method: 'POST',
      path: '/order/cancel',
      body: {},
